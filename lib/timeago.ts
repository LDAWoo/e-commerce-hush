export function timeAgo(dateParam: Date) {
    const getDifferenceInUnits = (unit: string, differenceInMilliseconds: number) => {
    ...
    if (getDifferenceInUnits("minute", differenceInMilliseconds) < 1) {
        ...
        return `${Math.round(getDifferenceInUnits("minute", differenceInMilliseconds))}m`;
    } else if (getDifferenceInUnits("day", differenceInMilliseconds) < 1) {
        return `${Math.round(getDifferenceInUnits("hour", differenceInMilliseconds))}h`;
    } else if (getDifferenceInUnits("week", differenceInMilliseconds) < 1) {
        return `${Math.round(getDifferenceInUnits("day", differenceInMilliseconds))}d`;
    } else if (getDifferenceInUnits("year", differenceInMilliseconds) < 1) {
        return `${Math.round(getDifferenceInUnits("month", differenceInMilliseconds))}mo`;
    } else {
        return `${Math.round(getDifferenceInUnits("year", differenceInMilliseconds))}y`;
    }
}
