...
const TagComponent: React.FC<TagComponentProps> = ({ title, colorName, selectedColor, setSelectedColor }) => {
    return (
        <div
            className={clsx("relative p-2 flex-shrink-0 text-xs cursor-pointer", {
