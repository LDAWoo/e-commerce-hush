...
export default function NotFoundPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-background">
            ...
            <main className="mt-[200px] mb-[40px] border-t ml-auto mr-auto p-[0_17px] md:p-[0_40px] w-full h-full max-w-[var(--page-max-width)]">
                <div className="flex flex-col items-center h-full pt-[40px] md:pt-[75px]">
                    <header className="mb-[30px] md:mb-[50px] pt-[80px] text-center">
                        ...
                        <div className="mb-[15px]">
                            <p className="m-[10px_0]">{t("LBL_SUBTITLE")}</p>
                            <p>
